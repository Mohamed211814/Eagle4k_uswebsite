        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 pt-2 border-t border-slate-800">
            <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-slate-200 text-xs leading-relaxed text-center font-medium">
              <span className="text-amber-400 font-extrabold block text-sm mb-0.5">💬 Contact Us via WhatsApp to Order:</span>
              Click the WhatsApp button below to complete your order and receive instant setup credentials.
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-emerald-100 font-medium">
                    Fast 2-Minute Setup & Credentials
                  </div>
                </div>
              </div>
