...
export const RESELLER_PLANS: ResellerPlan[] = [
  {
    ...
    credits: 240,
    yearsEquivalent: '10 Years Accounts (24 Credits = 1Y)',
    price: '$199',
    perCreditPrice: '$0.82 / credit ($19.90 per 1-Year Account)',
    discountBadge: 'STARTER PACK',
    features: [
      'Official Xtream UI Reseller Master Panel',
      '240 Credits (24 Credits = 1 Year Account)',
      '10 x 1-Year Accounts (or 20 x 6-Month Accounts)',
      'Create Unlimited 24H Free Trial Accounts',
      'Sub-Reseller Management Enabled',
      'Credits Never Expire',
      'Fast 24/7 VIP Support Channel',
    ],
    ctaText: '⚡ Order 240 Credits Panel ($199)',
  },
  {
    id: 'reseller-600',
    name: 'Super Reseller Panel',
    credits: 600,
    yearsEquivalent: '25 Years Accounts (24 Credits = 1Y)',
    price: '$450',
    perCreditPrice: '$0.75 / credit ($18.00 per 1-Year Account)',
    discountBadge: 'BEST VALUE BULK RATE',
    popular: true,
    features: [
      'Official Xtream UI Reseller Master Panel',
      '600 Credits (24 Credits = 1 Year Account)',
      '25 x 1-Year Accounts (or 50 x 6-Month Accounts)',
      'Unlimited Free Trials & Sub-Resellers',
      'Custom DNS Binding & Whitelabel Branding',
      'Credits Never Expire',
      '1-on-1 VIP Dedicated Manager & Priority Traffic',
    ],
    ctaText: '👑 Order 600 Credits Panel ($450)',
  },
];
